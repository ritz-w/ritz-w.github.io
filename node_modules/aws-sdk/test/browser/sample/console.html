  ...
  <div id="header" class="padding">
    ...
    <div id="login-buttons">
      ...
      <button id="login-google">
        <span class="g-signin" data-height="short" data-callback="loginToGoogle" data-clientid="156058024465.apps.googleusercontent.com" data-cookiepolicy="single_host_origin" data-requestvisibleactions="http://schemas.google.com/AddActivity" data-scope="https://www.googleapis.com/auth/plus.login">
        </span>
      </button>
    </div>
  </div>
